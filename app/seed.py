...
# PER-XX (demo polish): seed_demo_dashboard_data and seed_demo_widget_packages
# removed — they populated the DB with fake runs/screens/edges/defects and an
# example widget package so the UI looked alive on a fresh install. For real
# demos this is misleading: users see noise instead of their own data.
